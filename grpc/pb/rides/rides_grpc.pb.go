...
type RidesClient interface {
	...
	Update(ctx context.Context, opts ...grpc.CallOption) (Rides_UpdateClient, error)
}
...
func (c *ridesClient) Update(ctx context.Context, opts ...grpc.CallOption) (Rides_UpdateClient, error) {
	stream, err := c.cc.NewStream(ctx, &Rides_ServiceDesc.Streams[0], "/Rides/Update", opts...)
	if err != nil {
		return nil, err
	}
	x := &ridesUpdateClient{stream}
	return x, nil
}

type Rides_UpdateClient interface {
	Send(*UpdateRequest) error
	CloseAndRecv() (*UpdateResponse, error)
	grpc.ClientStream
}

type ridesUpdateClient struct {
	grpc.ClientStream
}

func (x *ridesUpdateClient) Send(m *UpdateRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *ridesUpdateClient) CloseAndRecv() (*UpdateResponse, error) {
...
type RidesServer interface {
	...
	Update(Rides_UpdateServer) error
...
func (UnimplementedRidesServer) Update(Rides_UpdateServer) error {
...
func _Rides_Update_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(RidesServer).Update(&ridesUpdateServer{stream})
}

type Rides_UpdateServer interface {
	SendAndClose(*UpdateResponse) error
	Recv() (*UpdateRequest, error)
	grpc.ServerStream
}

type ridesUpdateServer struct {
	grpc.ServerStream
}

func (x *ridesUpdateServer) SendAndClose(m *UpdateResponse) error {
	return x.ServerStream.SendMsg(m)
}

func (x *ridesUpdateServer) Recv() (*UpdateRequest, error) {
	m := new(UpdateRequest)
...
var Rides_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		{
			StreamName:    "Update",
			Handler:       _Rides_Update_Handler,
			ClientStreams: true,
		},
	},
	Metadata: "pb/rides/rides.proto",
}
